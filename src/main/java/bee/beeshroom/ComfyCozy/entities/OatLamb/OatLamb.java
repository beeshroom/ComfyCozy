//Haven't started this yet.... this is just vanilla sheep code for now


/* package bee.beeshroom.comfycozy.entities.OatLamb;
...
public class OatLamb extends AnimalEntity implements net.minecraftforge.common.IShearable {
    private static final DataParameter<Byte> DYE_COLOR = EntityDataManager.createKey(net.minecraft.entity.passive.SheepEntity.class, DataSerializers.BYTE);
    ...
    private static final Map<DyeColor, float[]> DYE_TO_RGB = Maps.newEnumMap(Arrays.stream(DyeColor.values()).collect(Collectors.toMap((DyeColor p_200204_0_) -> {
        return p_200204_0_;
    }, net.minecraft.entity.passive.SheepEntity::createSheepColor)));
    ...
    public OatLamb(EntityType<? extends net.minecraft.entity.passive.SheepEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public net.minecraft.entity.passive.SheepEntity createChild(AgeableEntity ageable) {
        net.minecraft.entity.passive.SheepEntity sheepentity = (net.minecraft.entity.passive.SheepEntity)ageable;
        net.minecraft.entity.passive.SheepEntity sheepentity1 = EntityType.SHEEP.create(this.world);
    ...
    private DyeColor getDyeColorMixFromParents(AnimalEntity father, AnimalEntity mother) {
        DyeColor dyecolor = ((net.minecraft.entity.passive.SheepEntity)father).getFleeceColor();
        DyeColor dyecolor1 = ((net.minecraft.entity.passive.SheepEntity)mother).getFleeceColor();
