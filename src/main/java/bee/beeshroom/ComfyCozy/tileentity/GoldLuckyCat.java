...
public class GoldLuckyCat extends TileEntity implements ITickableTileEntity {
    ...
    public GoldLuckyCat(final TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public GoldLuckyCat() {
        this(TileEntityInit.LUCKYCAT_GOLD.get());
    }
