...
public class SweetBerryOatmeal extends Item
{

    public SweetBerryOatmeal(Properties builder) {
        super(builder);
    }
   ...
   /*     if (stack.isEmpty())
    ...
    public ActionResultType onItemUse(ItemUseContext context)
    {
        ...
        if (player.isSneaking() && worldIn.isAirBlock(blockpos.up()))
        {
            ...
            BlockState blockstate = BlockInit.BOWL_SWEET_BERRY_OATMEAL.get().getDefaultState();
