...
//Major credit to Jabelar

public class WorldGenPeach extends WorldGenAbstractTree
{
    private IBlockState blockStateWood = ModBlocks.PEACH_LOG.getDefaultState();
    private IBlockState blockStateLeaves = ModBlocks.PEACH_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
    /** The minimum height of a generated tree. */
    private final int minTreeHeight = 5;

    public WorldGenPeach(boolean parShouldNotify)
    {
