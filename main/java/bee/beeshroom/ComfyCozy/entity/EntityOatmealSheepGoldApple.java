...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityOatmealSheepGoldApple extends EntityAnimal implements net.minecraftforge.common.IShearable
	{                                             //changed DYE_COLOR to OAT_FLAVOR
	    ...
	    private static final DataParameter<Byte> OAT_FLAVOR = EntityDataManager.<Byte>createKey(EntityOatmealSheepGoldApple.class, DataSerializers.BYTE);
	    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ModItems.OATS, Items.GOLDEN_APPLE, ModItems.GOLD_APPLE_CINNAMON_OATMEAL);
	...
	/*    public boolean processInteract(EntityPlayer player, EnumHand hand)
	    ...
	    */
	    ...
	    public boolean processInteract(EntityPlayer player, EnumHand hand)
	    {
	        ...
	        if (this.oats > 0 && !this.getSheared() && itemstack.getItem() == Items.BOWL && this.getGrowingAge() >= 0)
	        {
	            ...
	            {
	                player.setHeldItem(hand, new ItemStack(ModItems.GOLD_APPLE_CINNAMON_OATMEAL));
	            }
	            else if (!player.inventory.addItemStackToInventory(new ItemStack(ModItems.GOLD_APPLE_CINNAMON_OATMEAL)))
	            {
	                player.dropItem(new ItemStack(ModItems.GOLD_APPLE_CINNAMON_OATMEAL), false);
	            }
	        ...
	        //refill oat sheep
	        else if (this.getSheared() && itemstack.getItem() == Items.GOLDEN_APPLE && this.getGrowingAge() >= 0 || this.getSheared() && itemstack.getItem() == ModItems.GOLD_APPLE_CINNAMON_OATMEAL && this.getGrowingAge() >= 0)
	        {
	        	if (itemstack.getItem() == Items.GOLDEN_APPLE)
        		{
	        		itemstack.shrink(1);
        		}
	        	if (itemstack.getItem() == ModItems.GOLD_APPLE_CINNAMON_OATMEAL)
        		{
	        		itemstack.shrink(1);
	        		itemstack.shrink(1);
		            if (itemstack.isEmpty())
	 ...
	 //           this.spawnParticles(EnumParticleTypes.END_ROD);
	   ...
	   //         this.spawnParticles(EnumParticleTypes.END_ROD);
	    ...
	    {
	        EntityLiving.registerFixesMob(fixer, EntityOatmealSheepGoldApple.class);
	    }
	  ...
	  //
	    ...
	    public EntityOatmealSheepGoldApple createChild(EntityAgeable ageable)
	    {
	        EntityOatmealSheepGoldApple entityoatmealsheep = (EntityOatmealSheepGoldApple)ageable;
	        EntityOatmealSheepGoldApple entityoatmealsheep1 = new EntityOatmealSheepGoldApple(this.world);
            ...
            int j = MathHelper.floor(this.posY);
             int k = MathHelper.floor(this.posZ + (double)((float)(l / 2 % 2 * 2 - 1) * 0.25F));
                BlockPos blockpos = new BlockPos(i, j, k);
	                ...
	                {
	                	this.setDead(); 
	                	this.world.setBlockState(blockpos, ModBlocks.BOWL_GOLD_APPLE.getDefaultState()); 
