...
import bee.beeshroom.ComfyCozy.entity.models.ModelOatmealSheepStrawberry1;
...
public class LayerOatmealSheepOatsStrawberry implements LayerRenderer<EntityOatmealSheepStrawberry>
{//changed from textures/entity
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/oatmealsheep/oatmealsheep_fur_strawberry.png");
    private final RenderOatmealSheepStrawberry oatmealsheepRenderer;
    private final ModelOatmealSheepStrawberry1 oatmealsheepModel = new ModelOatmealSheepStrawberry1();

    public LayerOatmealSheepOatsStrawberry(RenderOatmealSheepStrawberry oatmealsheepRendererIn)
    {
        this.oatmealsheepRenderer = oatmealsheepRendererIn;
    }

    @Override
    public void doRenderLayer(EntityOatmealSheepStrawberry entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
