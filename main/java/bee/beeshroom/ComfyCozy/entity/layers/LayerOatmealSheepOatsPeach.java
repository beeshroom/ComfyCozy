...
public class LayerOatmealSheepOatsPeach implements LayerRenderer<EntityOatmealSheepPeach>
{//changed from textures/entity
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/oatmealsheep/oatmealsheep_fur_peach.png");
    private final RenderOatmealSheepPeach oatmealsheepRenderer;
    private final ModelOatmealSheepPeach1 oatmealsheepModel = new ModelOatmealSheepPeach1();

    public LayerOatmealSheepOatsPeach(RenderOatmealSheepPeach oatmealsheepRendererIn)
    {
        this.oatmealsheepRenderer = oatmealsheepRendererIn;
    }

    @Override
    public void doRenderLayer(EntityOatmealSheepPeach entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
