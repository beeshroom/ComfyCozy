...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityOatmealSheepCinnamon extends EntityAnimal implements net.minecraftforge.common.IShearable
	{                                             //changed DYE_COLOR to OAT_FLAVOR
	    ...
	    private static final DataParameter<Byte> OAT_FLAVOR = EntityDataManager.<Byte>createKey(EntityOatmealSheepCinnamon.class, DataSerializers.BYTE);
	    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ModItems.OATS, ModItems.CINNAMON, ModItems.CINNAMON_OATMEAL);
	    ...
	    */
	    ...
	    public boolean processInteract(EntityPlayer player, EnumHand hand)
	    {
	        ...
	        if (this.oats > 0 && !this.getSheared() && itemstack.getItem() == Items.BOWL && this.getGrowingAge() >= 0)
	        {
	            ...
	            {
	                player.setHeldItem(hand, new ItemStack(ModItems.CINNAMON_OATMEAL));
	            }
	            else if (!player.inventory.addItemStackToInventory(new ItemStack(ModItems.CINNAMON_OATMEAL)))
	            {
	                player.dropItem(new ItemStack(ModItems.CINNAMON_OATMEAL), false);
	            }
	        ...
	        //refill oat sheep
	        else if (this.getSheared() && itemstack.getItem() == ModItems.CINNAMON && this.getGrowingAge() >= 0 || this.getSheared() && itemstack.getItem() == ModItems.CINNAMON_OATMEAL && this.getGrowingAge() >= 0)
	        {
	        	if (itemstack.getItem() == ModItems.CINNAMON)
        		{
		            itemstack.shrink(1);
        		}
	        	if (itemstack.getItem() == ModItems.CINNAMON_OATMEAL)
        		{
		            itemstack.shrink(1);
		            itemstack.shrink(1);
		            if (itemstack.isEmpty())
	...
	//            this.spawnParticles(EnumParticleTypes.END_ROD);
	   ...
	   //         this.spawnParticles(EnumParticleTypes.END_ROD);
	    ...
	    {
	        EntityLiving.registerFixesMob(fixer, EntityOatmealSheepCinnamon.class);
	    }
	  ...
	  //
	    ...
	    public EntityOatmealSheepCinnamon createChild(EntityAgeable ageable)
	    {
	        EntityOatmealSheepCinnamon entityoatmealsheep = (EntityOatmealSheepCinnamon)ageable;
	        EntityOatmealSheepCinnamon entityoatmealsheep1 = new EntityOatmealSheepCinnamon(this.world);
            ...
            int j = MathHelper.floor(this.posY);
             int k = MathHelper.floor(this.posZ + (double)((float)(l / 2 % 2 * 2 - 1) * 0.25F));
                BlockPos blockpos = new BlockPos(i, j, k);
	                ...
	                {
	                	this.setDead(); 
	                	this.world.setBlockState(blockpos, ModBlocks.BOWL_CINNAMON.getDefaultState()); 
