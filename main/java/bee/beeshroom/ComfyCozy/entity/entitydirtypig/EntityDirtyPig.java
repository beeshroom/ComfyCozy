...
public class EntityDirtyPig extends EntityPig
{
    ...
    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(Items.CARROT, Items.POTATO, Items.BEETROOT, Item.getItemFromBlock(Blocks.DIRT));
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityDirtyPig.class);
    }
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt)
    {
        if (!this.world.isRemote && !this.isDead)
        {
            ...
            entitypigzombie.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(Items.GOLDEN_SHOVEL));
