...
import net.minecraftforge.fml.relauncher.SideOnly;
	...
	public class EntityOatmealSheepPeach extends EntityAnimal implements net.minecraftforge.common.IShearable
	{                                             //changed DYE_COLOR to OAT_FLAVOR
	    ...
	    private static final DataParameter<Byte> OAT_FLAVOR = EntityDataManager.<Byte>createKey(EntityOatmealSheepPeach.class, DataSerializers.BYTE);
	    private static final Set<Item> TEMPTATION_ITEMS = Sets.newHashSet(ModItems.OATS, ModItems.PEACH, ModItems.PEACH_OATMEAL);
	...
	/*    public boolean processInteract(EntityPlayer player, EnumHand hand)
	    ...
	    */
	    ...
	    public boolean processInteract(EntityPlayer player, EnumHand hand)
	    {
	        ...
	        if (this.oats > 0 && !this.getSheared() && itemstack.getItem() == Items.BOWL && this.getGrowingAge() >= 0)
	        {
	            ...
	            {
	                player.setHeldItem(hand, new ItemStack(ModItems.PEACH_OATMEAL));
	            }
	            else if (!player.inventory.addItemStackToInventory(new ItemStack(ModItems.PEACH_OATMEAL)))
	            {
	                player.dropItem(new ItemStack(ModItems.PEACH_OATMEAL), false);
	            }
	        ...
	        //refill oat sheep
	        else if (this.getSheared() && itemstack.getItem() == ModItems.PEACH && this.getGrowingAge() >= 0 || this.getSheared() && itemstack.getItem() == ModItems.PEACH_OATMEAL && this.getGrowingAge() >= 0)
	        {
	        	if (itemstack.getItem() == ModItems.PEACH)
	        		{
	        		itemstack.shrink(1);
	        		} 
	        	if (itemstack.getItem() == ModItems.PEACH_OATMEAL)
        		{
	            	itemstack.shrink(1);
	            	itemstack.shrink(1);
		            if (itemstack.isEmpty())
	  ...
	  //          this.spawnParticles(EnumParticleTypes.END_ROD);
	    ...
	    {
	        EntityLiving.registerFixesMob(fixer, EntityOatmealSheepPeach.class);
	    }
	  ...
	  //
	    ...
	    public EntityOatmealSheepPeach createChild(EntityAgeable ageable)
	    {
	        EntityOatmealSheepPeach entityoatmealsheep = (EntityOatmealSheepPeach)ageable;
	        EntityOatmealSheepPeach entityoatmealsheep1 = new EntityOatmealSheepPeach(this.world);
            ...
            int j = MathHelper.floor(this.posY);
             int k = MathHelper.floor(this.posZ + (double)((float)(l / 2 % 2 * 2 - 1) * 0.25F));
                BlockPos blockpos = new BlockPos(i, j, k);
	                ...
	                {
	                	this.setDead(); 
	                	this.world.setBlockState(blockpos, ModBlocks.BOWL_PEACH.getDefaultState()); 
